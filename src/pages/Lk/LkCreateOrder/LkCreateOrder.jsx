...
export const LkCreateOrder = (props) => {
  ...
  return (
    <section className={style.createOrder}>
          ...
          <div className={style.row}>
            ...
            {gallery.length === 0 ? null : (
              <div style={{ color: "green" }}>
                ...
                {gallery[2]?.[0]?.name} {gallery[3]?.[0]?.name}{" "}
                {gallery[4]?.[0]?.name}
              </div>
            )}
            <p>
            ...
            <div className={style.items}>
              <div
                ...
                onClick={() => {
                  ...
                  if (
                    tagRef1.current.style.background === "rgb(190, 68, 242)"
                  ) {
                    tagRef1.current.style.background = "";
                  } else {
              ...
              <div
                ...
                onClick={() => {
                  ...
                  if (
                    tagRef2.current.style.background === "rgb(190, 68, 242)"
                  ) {
                    tagRef2.current.style.background = "";
                  } else {
              ...
              <div
                ...
                onClick={() => {
                  ...
                  if (
                    tagRef3.current.style.background === "rgb(190, 68, 242)"
                  ) {
                    tagRef3.current.style.background = "";
                  } else {
            ...
            <div className={style.items}>
              <div
                ...
                onClick={() => {
                  ...
                  if (
                    tagRef4.current.style.background === "rgb(190, 68, 242)"
                  ) {
                    tagRef4.current.style.background = "";
                  } else {
              ...
              <div
                ...
                onClick={() => {
                  ...
                  if (
                    tagRef5.current.style.background === "rgb(190, 68, 242)"
                  ) {
                    tagRef5.current.style.background = "";
                  } else {
              ...
              <div
                ...
                onClick={() => {
                  ...
                  if (
                    tagRef6.current.style.background === "rgb(190, 68, 242)"
                  ) {
                    tagRef6.current.style.background = "";
                  } else {
            ...
            >
              <div
                ...
                onClick={() => {
                  ...
                  if (
                    tagRef7.current.style.background === "rgb(190, 68, 242)"
                  ) {
                    tagRef7.current.style.background = "";
                  } else {
              ...
              <div
                ...
                onClick={() => {
                  ...
                  if (
                    tagRef8.current.style.background === "rgb(190, 68, 242)"
                  ) {
                    tagRef8.current.style.background = "";
                  } else {
              ...
              <div
                ...
                onClick={() => {
                  ...
                  if (
                    tagRef9.current.style.background === "rgb(190, 68, 242)"
                  ) {
                    tagRef9.current.style.background = "";
                  } else {
